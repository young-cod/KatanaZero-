...
public:
	...
	HRESULT init(int width, int height, bool isAlpha = FALSE);
	HRESULT init(const char* fileName, int width, int height,
		BOOL trans = FALSE, COLORREF transColor = FALSE, bool isAlpha = FALSE);
	HRESULT init(const char* fileName, float x, float y,
		int width, int height, int frameX, int frameY,
		BOOL trans = FALSE, COLORREF transColor = FALSE, bool isAlpha = FALSE);
	HRESULT init(const char* fileName, int width, int height,
		int frameX, int frameY, BOOL trans = FALSE, COLORREF transColor = FALSE, bool isAlpha = FALSE);
	void release();
	...
	inline int setWidth(float num) { return _imageInfo->width = num; }
	inline int setHeight(float num) { return _imageInfo->height= num; }
	...
	inline bool getisAlpha() { return _isAlpha; }
};
